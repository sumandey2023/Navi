  ...
  return (
    <div className="flex items-start gap-2 sm:gap-4 max-w-4xl mx-auto px-4 sm:px-0">
      ...
      <div className="flex-1 min-w-0">
        <div className="inline-block px-3 sm:px-4 py-2 sm:py-3 rounded-2xl text-gray-100 bg-transparent w-full">
          <ReactMarkdown
...
const CopyButton = ({ text }) => {
  ...
  return (
    <button
      onClick={onCopy}
      className="absolute right-1 top-1 sm:right-2 sm:top-2 inline-flex items-center gap-1 px-1.5 sm:px-2 py-1 rounded bg-[#374151] text-gray-200 hover:bg-[#4b5563] transition-colors"
